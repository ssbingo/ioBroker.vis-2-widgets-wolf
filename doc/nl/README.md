...
Na de installatie staat het script ook in de browser klaar: `http://<iobroker>:8082/vis-2/widgets/vis-2-widgets-wolf/addon/gasverbrauch_statistik_v2.1.0.js`. Details in de [Engelse documentatie](../../README.md).
