...
После установки скрипт доступен и в браузере: `http://<iobroker>:8082/vis-2/widgets/vis-2-widgets-wolf/addon/gasverbrauch_statistik.js`. Подробности — в [английской документации](../../README.md).
