...
Po instalacji skrypt jest dostępny także w przeglądarce: `http://<iobroker>:8082/vis-2/widgets/vis-2-widgets-wolf/addon/gasverbrauch_statistik.js`. Szczegóły w [dokumentacji angielskiej](../../README.md).
